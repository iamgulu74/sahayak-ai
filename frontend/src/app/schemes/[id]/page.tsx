    ...
    <div className="page-container py-12 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="no-print flex flex-wrap gap-2.5 mt-6 pt-6 border-t border-slate-100">
            <Link
            ...
            <Link
              ...
              className="px-4 py-2 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-all"
            >
              <MapPin className="w-4 h-4 text-indigo-600" /> Find Nearest Channel Partner
            </Link>
            <a
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="no-print bg-white rounded-3xl border border-slate-200/80 p-5 shadow-sm space-y-3">
              ...
              <Link
                href={`/partners?scheme=${scheme.id}`}
                className="w-full py-2.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-all"
              >
